    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Dahiliye uzmanı olarak 10 yılı aşkın deneyime sahip", "/img/doctors/doctor1.jpg", "Dr. Ahmet Yılmaz", "Dahiliye" },
                    { 2, null, "Kulak Burun Boğaz hastalıkları konusunda uzman hekim", "/img/doctors/doctor3.jpg", "Dr. Mehmet Kaya", "KBB" },
                    { 3, null, "Kalp ve damar hastalıkları konusunda deneyimli uzman", "/img/doctors/doctor2.jpg", "Dr. Ali Öztürk", "Kardiyoloji" },
                    { 4, null, "Cilt hastalıkları ve estetik dermatoloji uzmanı", "/img/doctors/doctor7.jpg", "Dr. Can Yücel", "Dermatoloji" },
                    { 5, null, "Göz hastalıkları ve cerrahi operasyonlar konusunda uzman", "/img/doctors/doctor9.jpg", "Dr. Ece Şahin", "Göz Hastalıkları" },
                    { 6, null, "Ortopedi ve travmatoloji uzmanı", "/img/doctors/doctor11.jpg", "Dr. Gamze Özkan", "Ortopedi" },
                    { 7, null, "Nörolojik hastalıklar konusunda deneyimli uzman", "/img/doctors/doctor13.jpg", "Dr. İrem Doğan", "Nöroloji" },
                    { 8, null, "Psikiyatri ve psikoterapi konusunda uzman hekim", "/img/doctors/doctor15.jpg", "Dr. Kemal Tunç", "Psikiyatri" },
                    { 9, null, "Üroloji ve androloji uzmanı", "/img/doctors/doctor17.jpg", "Dr. Murat Ersoy", "Üroloji" },
                    { 10, null, "Kadın hastalıkları ve doğum uzmanı", "/img/doctors/doctor19.jpg", "Dr. Osman Kara", "Kadın Hastalıkları ve Doğum" },
                    { 11, null, "Endokrinoloji ve metabolizma hastalıkları uzmanı", "/img/doctors/doctor21.jpg", "Dr. Rıza Altın", "Endokrinoloji" }
                });
